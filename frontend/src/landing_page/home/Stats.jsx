        ...
        <div className="container mt-5 p-3">
            <div className="row p-5">
                <div className="col-6 p-5">
                    ...
                    <p className="text-muted">No gimmicks, spam, "gamification", or annoying push notifications. High quality apps that you see at your pace, the way you like.</p>
                ...
                <div className="col-6 p-5">
                    <img src="media/images/ecosystem.png" style={{width:"80%"}} alt="ecosystem" />
                    <div className="mt-5">
